...
En fil rouge, nous nous concentrons sur un scénario de bout en bout : un service de livraison par drone qui permet aux clients de planifier l’enlèvement et la livraison de colis par le biais d’un drone. Vous trouverez le code de notre implémentation de référence sur GitHub.
