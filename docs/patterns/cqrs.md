...
## <a name="when-to-use-this-pattern"></a><span data-ttu-id="b25f4-152">Quand utiliser ce modèle</span><span class="sxs-lookup"><span data-stu-id="b25f4-152">When to use this pattern</span></span>
