...
![Digramme des limites de contexte](./images/bounded-contexts.png)
...
## <a name="drone-delivery-defining-the-microservices"></a>Application Drone Delivery : Définition des microservices
...
![Schéma montrant la conception](./images/microservices.png)
