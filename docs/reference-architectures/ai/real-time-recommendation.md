...
Une implémentation de référence pour cette architecture est disponible sur [GitHub](https://github.com/Microsoft/Recommenders/blob/master/notebooks/05_operationalize/als_movie_o16n.ipynb).
