---
title: Intégration d’entreprise avec Azure Integration Services
...
Pour une fiabilité et une scalabilité supérieures, utilisez des files d’attente de messages et des événements pour découpler les systèmes back-end. Ce modèle est illustré dans l’architecture de référence suivante de cette série : [Intégration d’entreprise avec des files d’attente de messages et des événements](./queues-events.md).
