...
<span data-ttu-id="1e0f0-156">Ce modèle est utile dans les situations suivantes :</span><span class="sxs-lookup"><span data-stu-id="1e0f0-156">This pattern is useful for:</span></span>
