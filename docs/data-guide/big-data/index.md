...
**L’architecture kappa** a été proposée par Jay Kreps comme alternative à l’architecture lambda. Elle a les mêmes objectifs de base que l’architecture lambda, mais avec une différence importante : Toutes les données circulent en empruntant un même chemin, avec un système de traitement de flux.
