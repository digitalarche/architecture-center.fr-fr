---
title: Architectures de référence des applications multiniveau
...
ms.locfileid: "34007623"
---
<!-- This file is generated! -->
<!-- See the templates in ./build/reference-architectures  -->
<!-- See data in index.json -->

# <a name="n-tier-application-reference-architectures"></a>Architectures de référence des applications multiniveau
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Déployez des machines virtuelles et un réseau virtuel configuré pour une application multiniveau à l’aide de SQL Server sur Windows.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Application multiniveau multirégion avec SQL Server</h3>
                        <p>Déployez une application multiniveau sur deux régions pour la haute disponibilité, à l’aide des groupes de disponibilité AlwaysOn SQL Server.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Déployez des machines virtuelles Linux et un réseau virtuel configuré pour une application multiniveau à l’aide d’Apache Cassandra.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Machine virtuelle Windows</h3>
                        <p>Recommandations de base pour exécuter une machine virtuelle Windows dans Azure.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Recommandations de base pour exécuter une machine virtuelle Linux dans Azure.</p>
                    </div>
                </div>
            </div>
        </div>
