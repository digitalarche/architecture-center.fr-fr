...
Les pratiques recommandées sont définies pour la création d’environnements SAP hautement disponibles dans Azure. Pour plus d’informations, consultez [Scénarios et architecture de haute disponibilité pour SAP NetWeaver](/azure/virtual-machines/workloads/sap/sap-high-availability-architecture-scenarios).
Pour plus d’informations, consultez [Haute disponibilité pour SAP NetWeaver sur des machines virtuelles Azure](/azure/virtual-machines/workloads/sap/high-availability-guide).
