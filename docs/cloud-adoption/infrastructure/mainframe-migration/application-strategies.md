...
Pour obtenir des conseils détaillés sur le choix d’une solution de partenaire, consultez [Platform Modernization Alliance](https://www.platformmodernization.org/pages/mainframe.aspx).

## <a name="learn-more"></a>En savoir plus

Pour plus d’informations, consultez les ressources suivantes :

- [Prise en main d’Azure](/azure)

- [Platform Modernization Alliance : Migration d’ordinateurs mainframe](https://www.platformmodernization.org/pages/mainframe.aspx)
