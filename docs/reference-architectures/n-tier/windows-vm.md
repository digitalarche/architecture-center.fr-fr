...
Cet article décrit un ensemble de pratiques éprouvées pour l’exécution d’une machine virtuelle Windows dans Azure. Elle contient des recommandations pour le provisionnement de la machine virtuelle et des composants réseau et de stockage. [**Déployez cette solution.**](#deploy-the-solution)
