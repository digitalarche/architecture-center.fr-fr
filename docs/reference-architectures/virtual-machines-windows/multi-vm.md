...
Avec plusieurs machines virtuelles, il est important d’automatiser les processus afin qu’ils soient fiables et reproductibles. Vous pouvez utiliser [Azure Automation][azure-automation] pour automatiser le déploiement, les mises à jour correctives du système d’exploitation et d’autres tâches. [Azure Automation][azure-automation] est un service d’automatisation basé sur PowerShell. Des exemples de scripts d’automatisation sont disponibles dans la [Galerie de runbooks][runbook-gallery].
