...
ms.locfileid: "54113497"
---
# <a name="designing-microservices-interservice-communication"></a>Conception de microservices : Communication entre les services
...
![Diagramme de communication entre les services](./images/interservice-communication.png)
...
## <a name="drone-delivery-choosing-the-messaging-patterns"></a>Application Drone Delivery : Choix des modèles de messagerie
...
![Diagramme de communication avec les drones](./images/drone-communication.png)
