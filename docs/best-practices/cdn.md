...
Cette rubrique décrit certaines des meilleures pratiques, ainsi que des considérations générales sur l’utilisation d’un réseau CDN. Pour plus d’informations, consultez [Azure CDN](/azure/cdn/).
