...
# <a name="azure-resiliency-technical-guidance-recovery-from-local-failures-in-azure"></a>Guide technique de la résilience Azure : Récupération après des défaillances locales dans local
