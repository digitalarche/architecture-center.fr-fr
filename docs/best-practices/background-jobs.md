...
* **Déploiement** : vous pouvez déployer les scripts et exécutables à l’aide du [portail Azure](/azure/app-service-web/web-sites-create-web-jobs), de [Visual Studio](/azure/app-service-web/websites-dotnet-deploy-webjobs) ou du [Kit de développement logiciel (SDK) Azure WebJobs](/azure/app-service/webjobs-sdk-get-started), ou en les copiant directement aux emplacements suivants :
...
Pour plus d’informations, consultez [Leader Election Pattern](../patterns/leader-election.md) (Modèle de choix de l’instance responsable) et [Competing Consumers Pattern](../patterns/competing-consumers.md) (Modèle de consommateurs concurrents).
