...
- Les données en transit entre les grandes instances HANA et les machines virtuelles ne sont pas chiffrées. Pour chiffrer le transfert de données, activez le chiffrement spécifique à l’application. Consultez la Note SAP [2159014][sap-2159014] - FAQ: SAP HANA Security (FAQ : Sécurité de SAP HANA).
